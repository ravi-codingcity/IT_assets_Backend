...
const DEVICES = ['Desktop', 'Laptop', 'Tablet', 'Monitor', 'Printer', 'Scanner', 'Server', 'Network Device', 'Other', 'NA'];
...
exports.validateAsset = [
  body('serialNumber').optional().trim(), // Auto-generated by backend if not provided
